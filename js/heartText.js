...
export class HeartText {
    constructor(scene) {
        ...
        this.config = {
            text: 'I LOVE U MORE, CACA CANTIK',
            size: 30,
            height: 2,
            curveSegments: 12,
            bevelEnabled: true,
            ...
            metalness: 0.3,
            roughness: 0.2,
            effectType: 'float', //float fade rainbow pulse glow
            effectSpeed: 1.0,
            effectIntensity: 1.0,
            fontName: 'dancing_script', // font
            appearEffect: 'none' // fadein
        };
    ...
    async loadFont(fontName = this.config.fontName) {
        ...
        const fontMap = {
            ...
            dancing_script: 'assets/fonts/DancingScript.json',
